...
<td>
    <table WIDTH="100%">
        <tr BGCOLOR="lightblue" align="center">
            ...
            <td class='mytheme'><marquee behavior='slide'><a href='DeleteProfile.jsp'>DELETE</a></marquee></td>
            <td class='mytheme'><marquee behavior='slide'><a href='CreateProfile.jsp'>CREATE PROFILE</a></marquee></td>
        <td class='mytheme'><marquee behavior='slide'><a href='SearchProfile.jsp'>SEARCH</a></marquee></td>
